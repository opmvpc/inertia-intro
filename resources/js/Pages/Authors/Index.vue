                            ...
                            <div v-for="author in authors.data" :key="author.id" 
                                ...
                                <div class="p-6">
                                    <div class="flex items-center justify-center mb-4 w-full">
                                        <AuthorAvatar :name="author.name" :size="10" />
                                    </div>
                                    ...
                                    <div class="text-sm text-gray-600 text-center">
                                        <p>{{ author.books_count ?? 0 }} books published</p>
                                        <p class="mt-1">Member since {{ author.created_at }}</p>
                                    </div>
                                    
                                    <div class="mt-4 flex justify-center gap-2">
                                        <Link :href="route('authors.show', { author: author.id })"
                                              class="inline-flex text-center items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#FF2D20] focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                            View Profile
                                        </Link>
                                        ...
                                        <button @click="confirmAuthorDeletion(author)"
                                                class="inline-flex items-center p-1 border border-gray-300 rounded-md hover:bg-gray-50">
        ...
        <Modal :show="confirmingAuthorDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Once this author is deleted, all of their books will be permanently deleted.
                </p>
